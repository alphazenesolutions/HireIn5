    ...
    <div>
      <div className="workExperience">
        <div className="innerWorkExperience">
          ...
          {isArrow === true && <div className="workExperienceDesc">
           <div className="workExperience1">
            <h3>Add your Details to help us match you with the perfect opportunity</h3>
            <div className="workExperience2">
              ...
              <div className="workTopskills">
                  ...
                  <div className="workTopskills">
                    ...
                    <h2><img src={countryimg1} alt="" />Japan</h2>
                    <h2><img src={countryimg} alt="" />United Kingdom</h2>
                    <h2><img src={countryimg1} alt="" />Singapore</h2>
                  </div>
                </div>
            </div>
           </div>
                ...
                <div className="workExperinceOverlayLeft">
                    <div className="keySkills">
                      ...
                      <div className="keyskills2">
                        <button>Product Managelment <span><img src={billx} alt="" /></span></button>
                        <button>Python <span><img src={billx} alt="" /></span></button>
                        <button>Java  <span><img src={billx} alt="" /></span></button>
                      </div>
